...
Route::get('/favorit', 'LandingPageController@favorit')->name('favorit');
Route::get('/wisata/favorite/{id}', 'LandingPageController@toggleFavorite')->name('favorite-toggle');

Route::get('/home', 'HomeController@index')->name('home');


// prefix untuk admin panel 
