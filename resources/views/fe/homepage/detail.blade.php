            ...
            <div class="ro mt-5 mb-5">
                <center>
                    ...
                    @php
                        ...
                        if ($user) {
                            // Check if the user has already favorited this wisata
                            $isFavorite = \App\Models\Favorit::where('pengguna_id_222058', $user->id_222058)
                                ->where('wisata_id_222058', $wisata->id_222058)
                                ->exists();
                        }
                    @endphp

                    <a href="{{ route('favorite-toggle', $wisata->id_222058) }}"
                        class="btn 
            ...
            <div class="row">
                ...
                <div class="review-list">
                    @foreach ($review as $reviews)
                        @php
                            $user = \App\Models\Pengguna::where('id_222058', $reviews->pengguna_id_222058)->first();
                        @endphp
