                    ...
                    <div class="card-body">
                        ...
                        <div class="container section-title">
                                    ...
                                    <div class="card-body">
                                        <div class="form-group">
                                            <input type="text" class="form-control" name="no_tiket"
                                                placeholder="Input Nomor Tiket" value="{{ Request::get('no_tiket') }}">
                                            <button type="submit" class="btn btn-primary mt-2"
                                                style="float: right">Periksa</button>
                                        </div>
                                    </div>
                                </div>
                            </form>
                            ...
                            @if (Request::get('no_tiket') != null)
                                @php
                                    $tiketSearch = \App\Models\Tiket::where(
                                        'no_tiket_222058',
                                        Request::get('no_tiket'),
                                    )->first();
                                @endphp
                                @if ($tiketSearch != null)
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <div class="row">
                                                ...
                                                @else
                                                    <button class="btn btn-info">Tiket Sudah digunakan</bu>
                                                @endif
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                @if ($pembayaran->status_222058 == 'pending_confirmation')
                                                    <span class="badge badge-warning" style="background: #ffc673">Menunggu
                                                        Konfirmasi Admin</span>
                                                @elseif($pembayaran->status_222058 == 'complate')
                                                    <span class="badge badge-success" style="background: green">Pembayaran
                                                        Disetujui</span>
